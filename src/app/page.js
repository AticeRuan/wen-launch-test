  ...
  return (
    ...
    >
      <div className="bg-black w-screen h-screen relative overflow-hidden">
        ...
        <div className="absolute z-20  p-6 xl:top-[187px]  xl:right-[317px] xl:bottom-auto bottom-[calc(450px*944/1515)] right-[calc(50vw-140px)] md:bottom-[calc(800px*944/1515+10vh)] md:right-[calc(50vw-250px)]  bg-[rgba(0,0,0,0.5)] border-[rgba(255,255,255,0.4)] border-[1px] rounded-xl 2xl:border-none 2xl:bg-transparent ">
          <OptionBlock />
        </div>
